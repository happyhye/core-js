...
// console.log(friends.length = 0);  //배열 비울때사용
...
console.log(unshift); //9 : 총 length 를 반환함
...
let copiedArray2 = friends.slice(); //인스턴스메서드
let copiedArray3 = Array.from(friends); //스태틱메서드
